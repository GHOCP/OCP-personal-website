...
export default function Rtags({ researchMethods, intro, contributorMe, contributorOthers }: RtagsProps) {
  return (
    <ul
      ...
      3xl:col-span-12 3xl:col-start-3 3xl:row-span-1
      grid gap-x-[24px] gap-y-[30px] grid-cols-2 md:grid-cols-4 lg:grid-cols-4 3xl:grid-cols-4"
    >
      <li
        className="
